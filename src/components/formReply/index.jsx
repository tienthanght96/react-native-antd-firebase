    ...
    return (
      <View style={styles.wrapperHeader}>
        {isOpenModal && article_id && (
          <ModalReply
            {...this.props}
            onRequestClose={this.onToggleModalReply}
          />
        )}
        ...
        <View style={styles.containerButtonSearch}>
          <TouchableOpacity
            onPress={this.onToggleModalReply}
            style={styles.buttonSearch}
          >
            <Text style={styles.textSearch}>Thêm phản hồi ...</Text>
          </TouchableOpacity>
        </View>
      </View>
    );
